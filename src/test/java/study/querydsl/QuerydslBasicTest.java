...
public class QuerydslBasicTest {
    ...
    @BeforeEach
    public void before(){
        //동시성 문제 고민안해도 된담 문제없이 설계되있고
        //springboot에서 주인한 em 자체가 멀티쓰레드 처리 되어있음.
...
//                .fetchOne();
//
//        Member fetchFirest = jpaQueryFactory
...
//
    ...
    public void join(){
        ...
        List resultList = em.createQuery("select m from Member m join m.team")
                .getResultList();
...
//                .containsExactly("member1" , "member2");
    ...
    public void fetchJoinNo(){
        ...
        assertThat(loaded).as("패티 조인 미적용").isFalse();
    }
    ...
    public void fetchJoinUSe(){
        ...
        boolean loaded = emf.getPersistenceUnitUtil().isLoaded(findMember.getTeam());
        assertThat(loaded).as("패티 조인 미적용").isTrue();
    }
    ...
    @Test
    public void findDtoByCunstructor(){
        List<MemberDto> resultList = jpaQueryFactory
...
//        BooleanBuilder builder = new BooleanBuilder(member.username.eq(usernameCond));
    ...
    private BooleanExpression allEq(String usernamneCond, Integer ageCond){
        return usernameEq(usernamneCond).and(ageEq(ageCond));
    }
    ...
    public void bulkAdd(){
        long count = jpaQueryFactory
                .update(member)
                //multiply 가능
                .set(member.age, member.age.add(1)) // -1 가능
                .execute();
    }
